...
/**
 * AbstractBaseRepository interface, responsible for exposing database persistence functionalities.
 * <br>
 * <br>
 * Interface AbstractBaseRepository, é responsável por expor as funcionalidades de persistência de
 * dados.
 *
 * @author brunohenriquecontente
 * @param <T> - {@link AbstractBaseEntity AbstractBaseEntity}
 * @param <ID>
 */
@NoRepositoryBean
